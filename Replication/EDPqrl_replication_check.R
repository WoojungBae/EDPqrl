...
get_res_matrix <- function(model_name, scn, N, extra = NULL) {
  currentwd = getwd()
  setwd("/Users/woojung/Documents/Rproject/EDPqrl/SimulationStudy/True")
  file_true  <- paste0("True_Values_Scn", 1, ".txt")
...
# Load Data Matrices
# ==============================================================================
setwd("/Users/WooJung/Documents/Rproject/EDPqrl/SimulationStudy/Results")
...
# ==============================================================================
# Generate Tables (N=3000 vs N=5000)
# ==============================================================================
setwd("/Users/WooJung/Documents/Rproject/EDPqrl/SimulationStudy/Results")
edpmm_s4_3000  <- get_res_matrix("EDPMM", 4, 3000)
edpmm_s4_5000 <- get_res_matrix("EDPMM", 4, 5000)
dpmm_s4_3000  <- get_res_matrix("DPMM", 4, 3000)
dpmm_s4_5000 <- get_res_matrix("DPMM", 4, 5000)

generate_s4_extra_table_viewer(
  edpmm_s4_3000, edpmm_s4_5000, dpmm_s4_3000,  dpmm_s4_5000,
  table_title = "Scenario 4; N = 3000 vs N = 5000"
)
...
# # Helper: Calculate Metrics for a Single Scenario
# # ==============================================================================
# get_res_matrix <- function(model_name, scn, N, level = NULL) {
#   currentwd = getwd()
#   setwd("/Users/woojung/Documents/Rproject/EDPqrl/SimulationStudy/True")
#   file_true  <- paste0("True_Values_Scn", 1, ".txt")
#   if(!file.exists(file_true)) {
...
#     file_model <- paste0(model_name, "_Scn", scn, "_N", N, ".txt")
#   } else {
#     file_model <- paste0(model_name, "_Scn", scn, "_N", N, "level",100*level,".txt")
#   }
#   if(!file.exists(file_model)) {
#     warning(paste("Missing file:", file_model))
#     return(NULL)
...
# 
# generate_full_comparison_table_viewer <- function(
    #     edpmm_s1_500, edpmm_s1_1000, edpmm_s1_1500,
#     edpmm_s2_500, edpmm_s2_1000, edpmm_s2_1500,
#     edpmm_s3_500, edpmm_s3_1000, edpmm_s3_1500,
#     edpmm_s4_500, edpmm_s4_1000, edpmm_s4_1500,
#     dpmm_s1_500,  dpmm_s1_1000,  dpmm_s1_1500,
#     dpmm_s2_500,  dpmm_s2_1000,  dpmm_s2_1500,
#     dpmm_s3_500,  dpmm_s3_1000,  dpmm_s3_1500,
#     dpmm_s4_500,  dpmm_s4_1000,  dpmm_s4_1500,
#     table_title
# ) {
#   
#   make_block <- function(
    #     ed_left_500, ed_left_1000, ed_left_1500,
#     ed_right_500, ed_right_1000, ed_right_1500,
#     dp_left_500, dp_left_1000, dp_left_1500,
#     dp_right_500, dp_right_1000, dp_right_1500) {
#     
#     scale_cp <- function(df) {
#       if ("Cover" %in% names(df)) {
#         df$Cover <- 100 * as.numeric(as.character(df$Cover))
...
#     
#     ed_left_500   <- scale_cp(ed_left_500)
#     ed_left_1000  <- scale_cp(ed_left_1000)
#     ed_left_1500  <- scale_cp(ed_left_1500)
#     ed_right_500  <- scale_cp(ed_right_500)
#     ed_right_1000 <- scale_cp(ed_right_1000)
#     ed_right_1500 <- scale_cp(ed_right_1500)
#     
#     dp_left_500   <- scale_cp(dp_left_500)
#     dp_left_1000  <- scale_cp(dp_left_1000)
#     dp_left_1500  <- scale_cp(dp_left_1500)
#     dp_right_500  <- scale_cp(dp_right_500)
#     dp_right_1000 <- scale_cp(dp_right_1000)
#     dp_right_1500 <- scale_cp(dp_right_1500)
#     
#     meta_labels <- ed_left_500[, c("nu", "rho")]
#     metrics <- c("Bias", "RMSE", "Cover")
...
#       True = ed_left_500$True,
#       ed_left_500[, metrics],
#       ed_left_1000[, metrics],
#       ed_left_1500[, metrics],
#       ed_right_500[, metrics],
#       ed_right_1000[, metrics],
#       ed_right_1500[, metrics],
#       stringsAsFactors = FALSE
#     )
#     
...
#       True = dp_left_500$True,
#       dp_left_500[, metrics],
#       dp_left_1000[, metrics],
#       dp_left_1500[, metrics],
#       dp_right_500[, metrics],
#       dp_right_1000[, metrics],
#       dp_right_1500[, metrics],
#       stringsAsFactors = FALSE
#     )
#     
...
#     kableExtra::column_spec(5:7, background = "grey90") %>%
#     kableExtra::column_spec(8:10, background = "grey80") %>%
#     kableExtra::column_spec(11:13, background = "grey70") %>%
#     kableExtra::column_spec(14:16, background = "grey90") %>%
#     kableExtra::column_spec(17:19, background = "grey80") %>%
#     kableExtra::column_spec(20:22, background = "grey70") %>%
#     kableExtra::collapse_rows(columns = 1:2, valign = "top")
#   
#   bottom_tbl <- kableExtra::kbl(
#     final_bottom,
...
#   middle_rows <- paste0(
#     '\n<tr>',
#     '<td colspan="22" style="padding:0;height:8px;border-top:3px solid #444;background:white;"></td>',
#     '</tr>',
#     '\n<tr>',
#     '<td colspan="4" style="border:none;background:white;"></td>',
#     '<td colspan="9" style="text-align:center;font-weight:bold;font-size:120%;border:none;border-bottom:1px solid #bbb;background:white;">Scenario 3</td>',
#     '<td colspan="9" style="text-align:center;font-weight:bold;font-size:120%;border:none;border-bottom:1px solid #bbb;background:white;">Scenario 4</td>',
#     '</tr>\n'
#   )
#   
#   final_html <- sub(
...
#   
#   build_panel <- function(model_name,
#                           sleft_500, sleft_1000, sleft_1500,
#                           sright_500, sright_1000, sright_1500) {
#     
#     scale_cp <- function(df) {
#       if ("Cover" %in% names(df)) {
#         df$Cover <- 100 * as.numeric(as.character(df$Cover))
...
#     
#     sleft_500   <- scale_cp(sleft_500)
#     sleft_1000  <- scale_cp(sleft_1000)
#     sleft_1500  <- scale_cp(sleft_1500)
#     sright_500  <- scale_cp(sright_500)
#     sright_1000 <- scale_cp(sright_1000)
#     sright_1500 <- scale_cp(sright_1500)
#     
#     meta <- sleft_500[, c("nu", "rho")]
#     metrics <- c("Bias", "RMSE", "Cover")
...
#   mid_block <- paste0(
#     "\n\\midrule\n",
#     "\\multicolumn{4}{c}{} & \\multicolumn{9}{c}{60\\%} & \\multicolumn{9}{c}{80\\%} \\\\\n",
#     "\n\\midrule\n"
#   )
#   
#   out <- kbl(
...
#     add_header_above(header_scn) %>%
#     column_spec(4, background = "white") %>%
#     column_spec(5:7,   background = "#f2f2f2") %>%
#     column_spec(8:10,  background = "#e6e6e6") %>%
#     column_spec(11:13, background = "#d9d9d9") %>%
#     column_spec(14:16, background = "#f2f2f2") %>%
#     column_spec(17:19, background = "#e6e6e6") %>%
#     column_spec(20:22, background = "#d9d9d9") %>%
#     row_spec(8,  extra_latex_after = "\n\\cmidrule(l{3pt}r{3pt}){1-16}\n") %>%
#     row_spec(16, extra_latex_after = mid_block) %>%
#     row_spec(24, extra_latex_after = "\n\\cmidrule(l{3pt}r{3pt}){1-16}\n")
#   
#   out <- as.character(out)
#   out <- sub("\\\\begin\\{table\\}", "\\\\begin\\{table\\}[tbp]", out)
#   
...
# # --- EDPMM Data ---
# edpmm_s1_500  <- get_res_matrix("EDPMM", 1, 500)
# edpmm_s1_1000 <- get_res_matrix("EDPMM", 1, 1000)
# edpmm_s1_1500 <- get_res_matrix("EDPMM", 1, 1500)
# edpmm_s2_500  <- get_res_matrix("EDPMM", 2, 500)
# edpmm_s2_1000 <- get_res_matrix("EDPMM", 2, 1000)
# edpmm_s2_1500 <- get_res_matrix("EDPMM", 2, 1500)
# edpmm_s3_500  <- get_res_matrix("EDPMM", 3, 500)
# edpmm_s3_1000 <- get_res_matrix("EDPMM", 3, 1000)
# edpmm_s3_1500 <- get_res_matrix("EDPMM", 3, 1500)
# edpmm_s4_500  <- get_res_matrix("EDPMM", 4, 500)
# edpmm_s4_1000 <- get_res_matrix("EDPMM", 4, 1000)
# edpmm_s4_1500 <- get_res_matrix("EDPMM", 4, 1500)
# 
# # --- DPMM Data ---
# dpmm_s1_500  <- get_res_matrix("DPMM", 1, 500)
# dpmm_s1_1000 <- get_res_matrix("DPMM", 1, 1000)
# dpmm_s1_1500 <- get_res_matrix("DPMM", 1, 1500)
# dpmm_s2_500  <- get_res_matrix("DPMM", 2, 500)
# dpmm_s2_1000 <- get_res_matrix("DPMM", 2, 1000)
# dpmm_s2_1500 <- get_res_matrix("DPMM", 2, 1500)
# dpmm_s3_500  <- get_res_matrix("DPMM", 3, 500)
# dpmm_s3_1000 <- get_res_matrix("DPMM", 3, 1000)
# dpmm_s3_1500 <- get_res_matrix("DPMM", 3, 1500)
# dpmm_s4_500  <- get_res_matrix("DPMM", 4, 500)
# dpmm_s4_1000 <- get_res_matrix("DPMM", 4, 1000)
# dpmm_s4_1500 <- get_res_matrix("DPMM", 4, 1500)
# 
# # ==============================================================================
# # Generate Tables (N=500 vs N=1000 vs N=1500)
# # ==============================================================================
# # --- Table: EDPMM & DPMM (Scenario 1 vs 2 vs 3 vs 4 across N) ---
# generate_full_comparison_table_viewer(
#   edpmm_s1_500, edpmm_s1_1000, edpmm_s1_1500,
#   edpmm_s2_500, edpmm_s2_1000, edpmm_s2_1500,
#   edpmm_s3_500, edpmm_s3_1000, edpmm_s3_1500,
...
# )
# # ==============================================================================
# # Generate Tables (N=500 vs  N=1000 vs N=1500) when alpha = 0.01
# # ==============================================================================
# generate_s4_alpha001_table_viewer <- function(
    #     edpmm_s4_500, edpmm_s4_1000, edpmm_s4_1500,
#     dpmm_s4_500,  dpmm_s4_1000,  dpmm_s4_1500,
#     table_title = "Scenario 4, alpha = 0.01"
# ) {
...
#   }
#   
#   combine_model <- function(df_500, df_1000, df_1500, model_name) {
#     x500  <- prep_one(df_500,  "500")
#     x1000 <- prep_one(df_1000, "1000")[, c("nu", "rho", "Bias_1000", "RMSE_1000", "CP_1000")]
#     x1500 <- prep_one(df_1500, "1500")[, c("nu", "rho", "Bias_1500", "RMSE_1500", "CP_1500")]
#     
#     out <- merge(x500, x1000, by = c("nu", "rho"), all = TRUE)
#     out <- merge(out, x1500, by = c("nu", "rho"), all = TRUE)
#     
#     out$Model <- model_name
#     
#     out <- out[, c(
...
#   }
#   
#   ed_block <- combine_model(edpmm_s4_500, edpmm_s4_1000, edpmm_s4_1500, "EDPMM")
#   dp_block <- combine_model(dpmm_s4_500,  dpmm_s4_1000,  dpmm_s4_1500,  "DPMM")
#   
#   final_df <- rbind(ed_block, dp_block)
#   
#   display_df <- final_df
...
#   )
#   
#   cols_cp <- c("CP_500", "CP_1000", "CP_1500")
#   
#   display_df[cols_3dec] <- lapply(display_df[cols_3dec], function(x) sprintf("%.3f", x))
#   display_df[cols_cp]   <- lapply(display_df[cols_cp],   function(x) sprintf("%.1f", x))
#   
...
# 
# setwd("/Users/WooJung/Documents/Rproject/EDPqrl/SimulationStudy/Results")
# edpmm_s4_500  <- get_res_matrix("EDPMM", 4, 500, 0.01)
# edpmm_s4_1000 <- get_res_matrix("EDPMM", 4, 1000, 0.01)
# edpmm_s4_1500 <- get_res_matrix("EDPMM", 4, 1500, 0.01)
# 
# # --- DPMM Data ---
# dpmm_s4_500  <- get_res_matrix("DPMM", 4, 500, 0.01)
# dpmm_s4_1000 <- get_res_matrix("DPMM", 4, 1000, 0.01)
# dpmm_s4_1500 <- get_res_matrix("DPMM", 4, 1500, 0.01)
# 
# generate_s4_alpha001_table_viewer(
#   edpmm_s4_500, edpmm_s4_1000, edpmm_s4_1500,
#   dpmm_s4_500,  dpmm_s4_1000,  dpmm_s4_1500,
#   table_title = "Scenario 4, alpha = 0.01"
# )
