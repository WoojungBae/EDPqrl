...
# DPMM_results_MCMC_p025 = SURVIVAL_DPMM_MCMC(dfADNI, gibbs_iter, gibbs_burnin, gibbs_thin,
#                                             location = 0.25)
# DPMM_results_MCMC_m025 = SURVIVAL_DPMM_MCMC(dfADNI, gibbs_iter, gibbs_burnin, gibbs_thin,
#                                             location = -0.25)
...
# 
# # ------------------------------------------------------------------------
# # Average effects: DPMM
# # ------------------------------------------------------------------------
# DPMM_results_POST_p025 =
#   SURVIVAL_DPMM_POST_parallel(DPMM_results_MCMC_p025, M,
#                               nu, rho, eta_z0, eta_z1,
#                               level = level)
# 
# DPMM_results_POST_m025 =
#   SURVIVAL_DPMM_POST_parallel(DPMM_results_MCMC_m025, M,
#                               nu, rho, eta_z0, eta_z1,
#                               level = level)
# 
# SURVIVAL_DPMM_POST_ftn_results_p025 =
...
#                          level = level)
# 
# SURVIVAL_DPMM_POST_ftn_results_m025 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC_m025, M, t_grid,
#                          ftn = c("S", "f"),
#                          condX = NULL, p_condX = NULL,
#                          esttype = "mean",
#                          level = level)
...
# # Conditional effects: DPMM, location = -0.25
# # ------------------------------------------------------------------------
# SURVIVAL_DPMM_POST_condX1_m025 =
#   SURVIVAL_DPMM_POST_parallel(DPMM_results_MCMC_m025, M,
#                               nu, rho, eta_z0, eta_z1,
#                               condX = 1, p_condX = 1,
#                               level = level)
# 
# SURVIVAL_DPMM_POST_condX0_m025 =
#   SURVIVAL_DPMM_POST_parallel(DPMM_results_MCMC_m025, M,
#                               nu, rho, eta_z0, eta_z1,
#                               condX = 0, p_condX = 1,
#                               level = level)
# 
# SURVIVAL_DPMM_POST_ftn_condX1_results_m025 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC_m025, M, t_grid,
#                          ftn = c("S", "f"),
#                          condX = 1, p_condX = 1,
#                          esttype = "mean",
#                          level = level)
# 
# SURVIVAL_DPMM_POST_ftn_condX0_results_m025 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC_m025, M, t_grid,
#                          ftn = c("S", "f"),
#                          condX = 0, p_condX = 1,
#                          esttype = "mean",
#                          level = level)
# 
# save.image(paste0("~/Documents/Rproject/EDPqrl/RealDataAnalysis/DATA/ADNImcmc+post_level001_p025_m025.RData"))
...
#                               nu, rho, eta_z0, eta_z1,
#                               level = level)
# # print(EDPMM_results_POST_001$E_rho_nu_diff_result, max=1e5)
# # print(DPMM_results_POST_001$E_rho_nu_diff_result, max=1e5)
# 
...
#                           level = level)
# SURVIVAL_DPMM_POST_ftn_results_001 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC, M, t_grid, ftn = c("S", "f"),
#                          condX = NULL, p_condX = NULL, esttype = "mean",
#                          level = level)
# 
# # SURVIVAL_EDPMM_POST_ftn_results_001$S_z0_result
# # SURVIVAL_EDPMM_POST_ftn_results_001$S_z1_result
# # SURVIVAL_EDPMM_POST_ftn_results_001$S_z0_store
# # SURVIVAL_EDPMM_POST_ftn_results_001$S_z1_store
# 
# # SURVIVAL_DPMM_POST_ftn_results_001$S_z0_result
# # SURVIVAL_DPMM_POST_ftn_results_001$S_z1_result
# # SURVIVAL_DPMM_POST_ftn_results_001$S_z0_store
# # SURVIVAL_DPMM_POST_ftn_results_001$S_z1_store
# 
...
#                                condX = 0, p_condX = 1,
#                                level = level)
# # SURVIVAL_EDPMM_POST_condX1_001$E_rho_nu_diff_result
# # SURVIVAL_EDPMM_POST_condX0_001$E_rho_nu_diff_result
# 
# # DPMM
# # SURVIVAL_DPMM_POST_condX1_001 =
# #   SURVIVAL_DPMM_POST(DPMM_results_MCMC, M,
# #                      nu, rho, eta_z0, eta_z1,
# #                      condX = 1, p_condX = 1,
# #                      level = level)
# # SURVIVAL_DPMM_POST_condX0_001 =
# #   SURVIVAL_DPMM_POST(DPMM_results_MCMC, M,
# #                      nu, rho, eta_z0, eta_z1,
# #                      condX = 0, p_condX = 1,
# #                      level = level)
...
#                               condX = 0, p_condX = 1,
#                               level = level)
# # SURVIVAL_DPMM_POST_condX1_001$E_rho_nu_diff_result
# # SURVIVAL_DPMM_POST_condX0_001$E_rho_nu_diff_result
# 
# # summary(dfADNI$Tobs)
# # min:  0.0027
# # max: 14.8419
...
#                           level = level)
# SURVIVAL_DPMM_POST_ftn_condX1_results_001 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC, M, t_grid, ftn = c("S", "f"),
#                          condX = 1, p_condX = 1, esttype = "mean",
#                          level = level)
# SURVIVAL_DPMM_POST_ftn_condX0_results_001 =
#   SURVIVAL_DPMM_POST_ftn(DPMM_results_MCMC, M, t_grid, ftn = c("S", "f"),
#                          condX = 0, p_condX = 1, esttype = "mean",
#                          level = level)
# 
# # SURVIVAL_EDPMM_POST_ftn_condX1_results_001$S_z0_result
# # SURVIVAL_EDPMM_POST_ftn_condX1_results_001$S_z1_result
# # SURVIVAL_EDPMM_POST_ftn_condX1_results_001$S_z0_store
# # SURVIVAL_EDPMM_POST_ftn_condX1_results_001$S_z1_store
# # SURVIVAL_EDPMM_POST_ftn_condX0_results_001$S_z0_result
# # SURVIVAL_EDPMM_POST_ftn_condX0_results_001$S_z1_result
# # SURVIVAL_EDPMM_POST_ftn_condX0_results_001$S_z0_store
# # SURVIVAL_EDPMM_POST_ftn_condX0_results_001$S_z1_store
# #
# # SURVIVAL_DPMM_POST_ftn_condX1_results_001$S_z0_result
# # SURVIVAL_DPMM_POST_ftn_condX1_results_001$S_z1_result
# # SURVIVAL_DPMM_POST_ftn_condX1_results_001$S_z0_store
# # SURVIVAL_DPMM_POST_ftn_condX1_results_001$S_z1_store
# # SURVIVAL_DPMM_POST_ftn_condX0_results_001$S_z0_result
# # SURVIVAL_DPMM_POST_ftn_condX0_results_001$S_z1_result
# # SURVIVAL_DPMM_POST_ftn_condX0_results_001$S_z0_store
# # SURVIVAL_DPMM_POST_ftn_condX0_results_001$S_z1_store
# 
# save.image(paste0("~/Documents/Rproject/EDPqrl/RealDataAnalysis/DATA/ADNImcmc+post.RData"))
# 
# # ------------------------------------------------------------------------
...
# ------------------------------------------------------------------------
setwd("/Users/woojung/Documents/Rproject/EDPqrl/RealDataAnalysis/DATA")
load(paste0("~/Documents/Rproject/EDPqrl/RealDataAnalysis/DATA/ADNImcmc+post.RData"))
library(Rcpp)
library(RcppArmadillo)
...
# # ============================================================
# # TABLE 2: ALTERNATIVE PSI SETTINGS
# # complete only within exact existing psi/subgroup/rho combos
# # ============================================================
# 
# complete_osqc_table_source <- function(df) {
#   nu_labs <- factor(
#     paste0("nu = ", nu_keep_tbl),
#     levels = paste0("nu = ", nu_keep_tbl)
#   )
#   
#   df %>%
#     filter(!is_primary) %>%
#     group_by(setting_viewer, setting_latex, eta_z0, eta_z1, subgroup, rho_lab) %>%
#     tidyr::complete(
#       nu_lab = nu_labs,
#       fill = list(
#         mean_str = "NA",
...
# }
# 
# tab2_completed <- complete_osqc_table_source(df_osqc_master)
# 
# # check the exact problematic cells: should now be NA at nu = 0
# safe_print_all(
#   tab2_completed %>%
#     filter(
#       subgroup == "Overall",
...
#       rho_lab == "rho = 0.1"
#     ) %>%
#     select(setting_viewer, subgroup, rho_lab, nu_lab, mean_str, lwr_str, upr_str)
# )
# 
# tab2_viewer_df <- tab2_completed %>%
#   make_osqc_subcol_table(
#     row_vars = c("setting_viewer", "subgroup", "rho_lab")
#   )
# 
# # safe_view(tab2_viewer_df)
# 
# if (interactive()) {
#   show_osqc_subcol_table_viewer(
#     df = tab2_viewer_df,
#     row_vars = c("setting_viewer", "subgroup", "rho_lab"),
#     table_title = "Posterior mean OSQC estimates under alternative psi settings",
#     collapse_cols = c(1, 2)
#   )
# }
# 
# tab2_latex_df <- tab2_completed %>%
#   make_osqc_subcol_table(
#     row_vars = c("setting_latex", "subgroup", "rho_lab")
#   )
# 
# tab2_tex <- make_osqc_subcol_table_latex(
#   df = tab2_latex_df,
#   row_vars = c("setting_latex", "subgroup", "rho_lab"),
#   # table_title = "Posterior mean OSQC estimates under alternative residual-confounding sensitivity settings.",
#   table_title = "",
#   label = "tab:osqc_other_psi",
#   font_size = 7
# )
# 
# cat(tab2_tex, sep = "\n")
...
# # ------------------------------------------------------------------------
# # 2. OSQC vs rho: Overall / CN / MCI, sensitivity comparison ------------
# # columns = nu = 0 / 5 / 10
# # rows    = Overall / CN / MCI
# # ------------------------------------------------------------------------
# 
...
# 
# df_cond <- bind_rows(
#   make_panel_df(SURVIVAL_EDPMM_POST_condX0_001, "CN"),
#   make_panel_df(SURVIVAL_EDPMM_POST_condX1_001, "MCI")
# ) %>%
#   add_sens_label(spaced = FALSE) %>%
#   filter(!is.na(sens), nu %in% nu_keep)
# 
# df_plot_all <- bind_rows(df_overall, df_cond) %>%
#   mutate(
#     sens = factor(
#       sens,
#       levels = c("psi0=0, psi1=0", "psi0=-0.25, psi0=0.25", "psi0=0.25, psi0=-0.25")
#     ),
#     panel = factor(panel, levels = panel_levels),
#     nu = factor(nu, levels = c(0, 5, 10),
#                 labels = c("nu = 0", "nu = 5", "nu = 10"))
#   )
# 
# EDPqrlPOST_OSQCrho_nu_overall_CN_MCI_001 <-
#   ggplot(df_plot_all, aes(x = rho, y = estimYs, color = sens, fill = sens)) +
#   geom_hline(yintercept = 0, linetype = 2, color = "gray40") +
#   geom_ribbon(
#     aes(ymin = quantile025, ymax = quantile975),
#     alpha = 0.12, colour = NA
#   ) +
#   geom_line(linewidth = 0.9) +
#   facet_grid(panel ~ nu, scales = "free_y") +
#   scale_x_continuous(
#     breaks = rho_keep
#   ) +
...
#     color = "Sensitivity",
#     fill  = "Sensitivity",
#     title = "OSQC vs rho by subgroup at selected landmark times",
#     subtitle = "Rows show overall, CN, and MCI; columns show landmark times; lines show posterior means and ribbons show 99% credible intervals"
#   ) +
#   theme_bw(base_size = 12) +
#   theme(
#     legend.position = "bottom",
...
#   )
# 
# # quartz(type = "pdf", file = "EDPqrlPOST_OSQCrho_nu_overall_CN_MCI_001.pdf", width = 12, height = 10)
# print(EDPqrlPOST_OSQCrho_nu_overall_CN_MCI_001)
# # dev.off()
# 
# # ------------------------------------------------------------------------
# # 3. OSQC vs rho: EDPMM vs DPMM, Overall / CN / MCI ---------------------
# # columns = nu = 0 / 5 / 10
# # rows    = Overall / CN / MCI
# # ------------------------------------------------------------------------
# 
# df_both_all <- bind_rows(
#   make_model_df(EDPMM_results_POST_001, "Overall", "EDPMM"),
#   make_model_df(DPMM_results_POST_001,  "Overall", "DPMM"),
#   make_model_df(SURVIVAL_EDPMM_POST_condX0_001, "CN",  "EDPMM"),
#   make_model_df(SURVIVAL_DPMM_POST_condX0_001,  "CN",  "DPMM"),
#   make_model_df(SURVIVAL_EDPMM_POST_condX1_001, "MCI", "EDPMM"),
#   make_model_df(SURVIVAL_DPMM_POST_condX1_001,  "MCI", "DPMM")
# ) %>%
#   filter(eta_z0 == 0, eta_z1 == 0, nu %in% nu_keep) %>%
#   mutate(
...
#   )
# 
# rho_breaks <- sort(unique(df_both_all$rho))
# 
# EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI_001 <-
#   ggplot(df_both_all, aes(x = rho, y = estimYs, color = model, fill = model)) +
#   geom_hline(yintercept = 0, linetype = 2, color = "gray40") +
#   geom_ribbon(
#     aes(ymin = quantile025, ymax = quantile975),
#     alpha = 0.12, colour = NA
...
#     color = "Model",
#     fill = "Model",
#     title = "OSQC: EDPMM vs DPMM by subgroup at selected landmark times",
#     subtitle = "Rows show overall, CN, and MCI; columns show landmark times; lines show posterior means and ribbons show 99% credible intervals"
#   ) +
#   theme_bw(base_size = 12) +
#   theme(
...
# 
# # quartz(type = "pdf",
# #        file = "EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI_001.pdf",
# #        width = 12, height = 10)
# print(EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI_001)
# # dev.off()
# 
# # ------------------------------------------------------------------------
# # 4. OSQC vs landmark time: Overall / CN / MCI ---------------------------
# # rows = Overall / CN / MCI
# # cols = rho
# # ------------------------------------------------------------------------
# 
# df_edpm_cond_nu <- bind_rows(
#   make_subgroup_df(EDPMM_results_POST_001, "Overall"),
#   make_subgroup_df(SURVIVAL_EDPMM_POST_condX0_001, "CN"),
#   make_subgroup_df(SURVIVAL_EDPMM_POST_condX1_001, "MCI")
# ) %>%
#   filter(
#     (eta_z0 ==  0.00 & eta_z1 ==  0.00) |
#       (eta_z0 == -0.25 & eta_z1 ==  0.25) |
#       (eta_z0 ==  0.25 & eta_z1 == -0.25)
#   ) %>%
#   add_sens_label(spaced = TRUE) %>%
#   mutate(
#     subgroup = factor(subgroup, levels = panel_levels),
#     rho = factor(
#       rho,
...
#   )
# 
# EDPqrlPOST_condOSQCnu_EDPMM_001 <-
#   ggplot(
#     df_edpm_cond_nu,
#     aes(x = nu, y = estimYs, group = sens, color = sens, fill = sens)
#   ) +
#   geom_hline(yintercept = 0, linetype = 2, color = "gray40") +
#   geom_ribbon(
#     aes(ymin = quantile025, ymax = quantile975),
...
#     subtitle = "Rows show overall, CN, and MCI; columns show rho; lines show posterior means and ribbons show 99% credible intervals"
#   ) +
#   theme_bw(base_size = 12) +
#   theme(
#     plot.title = element_text(hjust = 0.5, face = "bold"),
...
#   )
# 
# # quartz(type = "pdf", file = "EDPqrlPOST_condOSQCnu_EDPMM_001.pdf", width = 10, height = 8)
# print(EDPqrlPOST_condOSQCnu_EDPMM_001)
# # dev.off()
...
#         sens = case_when(
#           eta_z0 ==  0.00 & eta_z1 ==  0.00 ~ "psi0=0, psi1=0",
#           eta_z0 == -0.25 & eta_z1 ==  0.25 ~ "psi0=-0.25, psi0=0.25",
#           eta_z0 ==  0.25 & eta_z1 == -0.25 ~ "psi0=0.25, psi0=-0.25",
#           TRUE ~ NA_character_
#         )
#       )
...
#       linetype = "dashed", linewidth = 0.85, alpha = 0.8
#     ) +
#     scale_color_manual(values = amyloid_cols_overall, name = "Amyloid status") +
#     scale_fill_manual(values = amyloid_cols_overall, name = "Amyloid status") +
#     labs(
#       x = "Time (years)",
#       y = "Probability of remaining dementia-free",
#       subtitle = panel_subtitle
...
# # ------------------------------------------------------------------------
# 
# # Posterior survival dfs
# df_S_overall <- make_S_df(SURVIVAL_EDPMM_POST_ftn_results)
# 
# df_S_cond <- bind_rows(
#   make_cond_surv_df(SURVIVAL_EDPMM_POST_ftn_condX0_results$S_z0_result, "CN",  "Non-Elevated"),
#   make_cond_surv_df(SURVIVAL_EDPMM_POST_ftn_condX0_results$S_z1_result, "CN",  "Elevated"),
#   make_cond_surv_df(SURVIVAL_EDPMM_POST_ftn_condX1_results$S_z0_result, "MCI", "Non-Elevated"),
#   make_cond_surv_df(SURVIVAL_EDPMM_POST_ftn_condX1_results$S_z1_result, "MCI", "Elevated")
# ) %>%
#   mutate(
#     subgroup = factor(subgroup, levels = c("CN", "MCI")),
#     amyloid  = factor(amyloid, levels = c("Non-Elevated", "Elevated"))
...
#   plot_layout(ncol = 3, guides = "collect", axis_titles = "collect") +
#   plot_annotation(
#     title = "Dementia-Free Survival by Amyloid Status",
#     subtitle = "Solid lines show EDPMM posterior means and ribbons show 95% credible intervals; dashed lines show unadjusted KM"
#   ) &
#   theme(
#     legend.position = "bottom",
#     plot.title = element_text(hjust = 0.5, face = "bold"),
...
#   )
# 
# # quartz(type = "pdf", file = "EDPqrlPOST_survival_all3.pdf", width = 18, height = 5.5)
...
# # ------------------------------------------------------------------------
# 
# df_overall <- make_panel_df(EDPMM_results_POST, "Overall") %>%
#   add_sens_label(spaced = FALSE) %>%
#   filter(!is.na(sens), nu %in% nu_keep)
# 
# df_cond <- bind_rows(
#   make_panel_df(SURVIVAL_EDPMM_POST_condX0, "CN"),
#   make_panel_df(SURVIVAL_EDPMM_POST_condX1, "MCI")
# ) %>%
#   add_sens_label(spaced = FALSE) %>%
#   filter(!is.na(sens), nu %in% nu_keep)
# 
...
#   )
# 
# EDPqrlPOST_OSQCrho_nu_overall_CN_MCI <-
#   ggplot(df_plot_all, aes(x = rho, y = estimYs, color = sens, fill = sens)) +
#   geom_hline(yintercept = 0, linetype = 2, color = "gray40") +
#   geom_ribbon(
#     aes(ymin = quantile025, ymax = quantile975),
...
#     fill  = "Sensitivity",
#     title = "OSQC vs rho by subgroup at selected landmark times",
#     subtitle = "Rows show overall, CN, and MCI; columns show landmark times; lines show posterior means and ribbons show 95% credible intervals"
#   ) +
#   theme_bw(base_size = 12) +
#   theme(
#     legend.position = "bottom",
...
#   )
# 
# # quartz(type = "pdf", file = "EDPqrlPOST_OSQCrho_nu_overall_CN_MCI.pdf", width = 12, height = 10)
# print(EDPqrlPOST_OSQCrho_nu_overall_CN_MCI)
# # dev.off()
# 
# # ------------------------------------------------------------------------
# # 3. OSQC vs rho: EDPMM vs DPMM, Overall / CN / MCI ---------------------
...
# 
# df_both_all <- bind_rows(
#   make_model_df(EDPMM_results_POST, "Overall", "EDPMM"),
#   make_model_df(DPMM_results_POST,  "Overall", "DPMM"),
#   make_model_df(SURVIVAL_EDPMM_POST_condX0, "CN",  "EDPMM"),
#   make_model_df(SURVIVAL_DPMM_POST_condX0,  "CN",  "DPMM"),
#   make_model_df(SURVIVAL_EDPMM_POST_condX1, "MCI", "EDPMM"),
#   make_model_df(SURVIVAL_DPMM_POST_condX1,  "MCI", "DPMM")
# ) %>%
#   filter(eta_z0 == 0, eta_z1 == 0, nu %in% nu_keep) %>%
#   mutate(
#     model = factor(model, levels = model_levels),
...
# rho_breaks <- sort(unique(df_both_all$rho))
# 
# EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI <-
#   ggplot(df_both_all, aes(x = rho, y = estimYs, color = model, fill = model)) +
#   geom_hline(yintercept = 0, linetype = 2, color = "gray40") +
#   geom_ribbon(
#     aes(ymin = quantile025, ymax = quantile975),
...
# 
# # quartz(type = "pdf",
# #        file = "EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI.pdf",
# #        width = 12, height = 10)
# print(EDPqrlPOST_OSQCrho_nu_EDPMMvsDPMM_overall_CN_MCI)
# # dev.off()
# 
# # ------------------------------------------------------------------------
# # 4. OSQC vs landmark time: Overall / CN / MCI ---------------------------
...
# 
# df_edpm_cond_nu <- bind_rows(
#   make_subgroup_df(EDPMM_results_POST, "Overall"),
#   make_subgroup_df(SURVIVAL_EDPMM_POST_condX0, "CN"),
#   make_subgroup_df(SURVIVAL_EDPMM_POST_condX1, "MCI")
# ) %>%
#   filter(
#     (eta_z0 ==  0.00 & eta_z1 ==  0.00) |
#       (eta_z0 == -0.25 & eta_z1 ==  0.25) |
...
#     fill = "Sensitivity setting",
#     title = "OSQC vs landmark time",
#     subtitle = "Rows show overall, CN, and MCI; columns show rho; lines show posterior means and ribbons show 95% credible intervals"
#   ) +
#   theme_bw(base_size = 12) +
#   theme(
#     plot.title = element_text(hjust = 0.5, face = "bold"),
...
#   )
# 
# # quartz(type = "pdf", file = "EDPqrlPOST_condOSQCnu_EDPMM.pdf", width = 10, height = 8)
# print(EDPqrlPOST_condOSQCnu_EDPMM)
# # dev.off()
# 
